class TextManager
{
  ...
  static const String loginBodyText ='Please enter your phone number to verify your account';
  ...
  static const String enter6NumToVerify = "Enter your 6 digit code numbers sent to you at ";
